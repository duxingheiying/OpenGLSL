...
void Do_Movement();
GLuint loadTexture(const GLchar* path, const GLboolean alpha = false);
...
#pragma region "object_initialization"
	...
	GLuint floorTexture = loadTexture("metal.jpg");
...
GLuint loadTexture(const GLchar* path, const GLboolean alpha)
{
